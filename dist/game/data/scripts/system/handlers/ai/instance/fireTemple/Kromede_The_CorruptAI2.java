...
public class Kromede_The_CorruptAI2 extends AggressiveNpcAI2
{
	...
	private void suspiciousObject() {
		...
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			@Override
			public void run() {
				if (getPosition().getWorldMapInstance().getNpc(280501) == null) {
					rndSpawn(280501, 3);
				}
			}
		}, 3000);
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
		        ...
		        deleteNpcs(instance.getNpcs(280501));
			}
		}, 23000);
	}
	...
	protected void handleBackHome() {
		...
		isHome.set(true);
		WorldMapInstance instance = getPosition().getWorldMapInstance();
		killNpc(instance.getNpcs(280501));
	}
