...
public class Brigade_General_AnuhartAI2 extends AggressiveNpcAI2
{
	...
	private void addPercent() {
		percents.clear();
		Collections.addAll(percents, new Integer[]{60, 25, 20});
	}
		...
		for (Integer percent: percents) {
			if (hpPercentage <= percent) {
				switch (percent) {
					...
					case 20:
					    faithfulSubordinate();
						scheduleSkill(18238, 0); //Summoning Ritual.
					break;
					case 25:
						scheduleSkill(18216, 0); //Recovery.
					break;
				}
	...
	protected void handleBackHome() {
		...
		killNpc(instance.getNpcs(281245));
	}
