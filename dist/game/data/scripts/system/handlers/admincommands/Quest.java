...
public class Quest extends AdminCommand {
	...
	public void execute(Player admin, String... params) {
		...
		if (params[0].equals("start")) {
			...
			PacketSendUtility.sendPacket(target, new S_QUEST(questId, qs.getStatus(), qs.getQuestVars().getQuestVars()));
		...
		if (params[0].equals("delete")) {
			...
			if (list == null || list.getQuestState(id) == null) {
				...
				PacketSendUtility.sendPacket(admin, new S_LOAD_FINISHEDQUEST(admin.getQuestStateList().getAllFinishedQuests()));
