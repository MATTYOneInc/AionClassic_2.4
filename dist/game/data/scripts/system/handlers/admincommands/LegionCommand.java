		...
		if(params[0].equalsIgnoreCase("disband")) {
			...
			for(int memberId : members) {
				...
				if(pl != null)
					...
					PlayerCommonData pcd = PlayerDAO.loadPlayerCommonData(memberId);
			...
			PacketSendUtility.broadcastPacketToLegion(target.getLegion(), new S_CHANGE_GUILD_MEMBER_INFO(bgplayer, 0, ""));
			...
			PacketSendUtility.broadcastPacketToLegion(target.getLegion(), new S_CHANGE_GUILD_MEMBER_INFO(target, 0, ""));
