...
public class AddTitle extends AdminCommand
{
	...
	public void execute(Player player, String... params) {
		...
		if ((titleId > 312) || (titleId < 1)) {
			PacketSendUtility.sendMessage(player, "title id " + titleId + " is invalid (must be between 1 and 313)");
			return;
		}
		Player target = null;
		if (params.length == 2) {
			...
			titleId = target.getRace().getRaceId() * 312 + titleId;
