...
public class _2042The_Last_Checkpoint extends QuestHandler
{
	...
	private final static int[] npcs = {204301, 204319};
	...
	public boolean onQuestTimerEndEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var >= 2 && var < 8) {
				...
				PacketSendUtility.sendWhiteMessage(player, "You failed the flight test, talk to Yornduf again.");
				return true;
			}
		}
		return false;
