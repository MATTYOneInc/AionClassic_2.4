...
public class _11116Munching_Mookie_Pickles extends QuestHandler
{
	private final static int questId = 11116;
	
	public _11116Munching_Mookie_Pickles() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(798964).addOnTalkEvent(questId);
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			...
			if (targetId == 798964) {
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						removeQuestItem(env, 182206791, 1);
						return closeDialogWindow(env);
					}
                }
            }
            ...
            if (targetId == 798986) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182206792, 1);
