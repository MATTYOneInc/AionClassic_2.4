...
public class _11061Twilight_Of_Ragna extends QuestHandler
{
	...
	private final static int[] DF4_LizardTest_Mutant_Nmd_55_Al = {216576};
	...
	public void register() {
		...
		for (int mob: DF4_LizardTest_Mutant_Nmd_55_Al) {
	...
	public boolean onKillEvent(final QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 1) {
				if (var1 >= 0 && var1 < 0) {
					return defaultOnKillEvent(env, DF4_LizardTest_Mutant_Nmd_55_Al, var1, var1 + 1, 1);
				} else if (var1 == 0) {
					qs.setQuestVar(2);
