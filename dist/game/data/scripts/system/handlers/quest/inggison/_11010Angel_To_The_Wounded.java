...
public class _11010Angel_To_The_Wounded extends QuestHandler
{
	private final static int questId = 11010;
	
	public _11010Angel_To_The_Wounded() {
		super(questId);
	}
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 799071) {
				if (env.getDialog() == QuestDialog.SELECT_REWARD) {
					removeQuestItem(env, 182206713, 1);
