...
public class _1205A_New_Skill extends QuestHandler
{
	private final static int questId = 1205;
	
	public _1205A_New_Skill() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerQuestNpc(203087).addOnTalkEvent(questId);
		qe.registerQuestNpc(203088).addOnTalkEvent(questId);
		qe.registerQuestNpc(203089).addOnTalkEvent(questId);
		qe.registerQuestNpc(203090).addOnTalkEvent(questId);
	}
