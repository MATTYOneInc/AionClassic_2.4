...
public class _30111Center_Of_The_Web extends QuestHandler
{
	private final static int questId = 30111;
	private final static int[] IDTemple_OctacideNamed_54_Ah = {215792};
	
	public _30111Center_Of_The_Web() {
		super(questId);
	}
	...
	public void register() {
		...
		for (int mob: IDTemple_OctacideNamed_54_Ah) {
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 1) {
				...
				if (var1 >= 0 && var1 < 0) {
					return defaultOnKillEvent(env, IDTemple_OctacideNamed_54_Ah, var1, var1 + 1, 1);
				} else if (var1 == 0) {
					qs.setQuestVar(1);
