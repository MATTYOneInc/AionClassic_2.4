...
public class _3931How_To_Use_Stigma extends QuestHandler
{
	private final static int questId = 3931;
	
	public _3931How_To_Use_Stigma() {
		super(questId);
	}
	
	@Override
	public void register() {
		qe.registerQuestNpc(203711).addOnQuestStart(questId);
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 203711) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182206081, 1);
