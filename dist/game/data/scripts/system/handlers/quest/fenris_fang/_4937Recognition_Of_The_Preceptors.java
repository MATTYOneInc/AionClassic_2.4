...
public class _4937Recognition_Of_The_Preceptors extends QuestHandler
{
	...
	private final static int[] npcs = {204053, 204059, 204058, 204057, 204056, 204075};
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			...
			if (targetId == 204059) {
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						giveQuestItem(env, 182207113, 1);
						removeQuestItem(env, 182207112, 1);
						return closeDialogWindow(env);
					}
                }
            } if (targetId == 204075) {
            ...
            if (targetId == 204053) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182207113, 1);
