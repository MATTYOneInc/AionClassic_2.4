...
public class _1385Rescuing_Griffo extends QuestHandler
{
	private final static int questId = 1385;

	public _1385Rescuing_Griffo() {
		super(questId);
	}
			...
			if (targetId == 204029) {
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						return defaultStartFollowEvent(env, (Npc) env.getVisibleObject(), 204028, 0, 1);
					}
                }
            }
