...
public class _1466Respect_For_Deltras extends QuestHandler
{
	private final static int questId = 1466;
	
	public _1466Respect_For_Deltras() {
		super(questId);
	}
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 203903) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182201385, 1);
	...
	public HandlerResult onItemUseEvent(final QuestEnv env, Item item) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			if (player.isInsideZone(ZoneName.get("EXECUTION_GROUND_OF_DELTRAS_220020000"))) {
				useQuestItem(env, item, 0, 1, true, 182201385, 1, 0);
