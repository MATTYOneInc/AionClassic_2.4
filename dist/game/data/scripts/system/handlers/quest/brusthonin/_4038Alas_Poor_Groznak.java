...
public class _4038Alas_Poor_Groznak extends QuestHandler
{
	...
	public void register() {
		...
		qe.registerQuestNpc(730155).addOnTalkEvent(questId);
	}
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						if (QuestService.collectItemCheck(env, true)) {
							...
							QuestService.addNewSpawn(220050000, player.getInstanceId(), 214555, player.getX(), player.getY(), player.getZ(), (byte) 0);
