...
public class InGameShopDAO
{
	...
	public static FastMap<Byte, List<IGItem>> loadInGameShopItems()
	{
	...
	public static void saveIngameShopItem(int objectId, int itemId, long itemCount, long itemPrice, byte category, byte subCategory, int list, int salesRanking,
