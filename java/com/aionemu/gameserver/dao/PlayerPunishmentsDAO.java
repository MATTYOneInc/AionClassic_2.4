...
public class PlayerPunishmentsDAO
{
	...
	public static void loadPlayerPunishments(final Player player, final PunishmentType punishmentType)
	{
	...
	public static void storePlayerPunishments(final Player player, final PunishmentType punishmentType)
	{
	...
	public static void punishPlayer(final int playerId, final PunishmentType punishmentType, final long duration, final String reason)
	{
	...
	public static void punishPlayer(final Player player, final PunishmentType punishmentType, final String reason)
	{
		if (punishmentType == PunishmentType.PRISON)
	...
	public static void unpunishPlayer(final int playerId, final PunishmentType punishmentType)
	{
	...
	public static CharacterBanInfo getCharBanInfo(final int playerId)
	{
