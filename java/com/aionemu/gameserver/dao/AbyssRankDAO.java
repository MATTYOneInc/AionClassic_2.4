...
public class AbyssRankDAO
{
	...
	public static final String SELECT_QUERY = "SELECT * FROM abyss_rank WHERE player_id = ?";
	...
	public static void loadAbyssRank(final Player player)
	{
	...
	public static ArrayList<AbyssRankingResult> getAbyssRankingPlayers(final Race race)
	{
		Connection con = null;
	...
	public static ArrayList<AbyssRankingResult> getAbyssRankingLegions(final Race race)
	{
		final ArrayList<AbyssRankingResult> results = new ArrayList<AbyssRankingResult>();
	...
	public static Map<Integer, Integer> loadPlayersAp(final Race race, final int lowerApLimit, final int maxOfflineDays)
	{
	...
	public static void updateAbyssRank(int playerId, AbyssRankEnum rankEnum)
	{
		Connection con = null;
		try {
			con = DatabaseFactory.getConnection();
	...
	public static void removePlayer(List<Player> listP)
	{
	...
	private static boolean addRank(final int objectId, final AbyssRank rank)
	{
		Connection con = null;
		try {
			con = DatabaseFactory.getConnection();
	...
	private static boolean updateRank(final int objectId, final AbyssRank rank) {
		Connection con = null;
		try {
			con = DatabaseFactory.getConnection();
	...
	private static int getLegionMembersCount(final int legionId)
	{
