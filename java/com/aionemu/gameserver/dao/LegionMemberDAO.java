 ...
 * @author Simple
 */
public class LegionMemberDAO extends IDFactoryAwareDAO
{
	...
	{
		return DB.insertUpdate(INSERT_LEGIONMEMBER_QUERY, preparedStatement -> {
	 ...
	 *
	 * @param legionId LegionId
	 * @return ArrayList<Integer>
	 */
	public static ArrayList<Integer> loadLegionMembers(final int legionId)
	{
