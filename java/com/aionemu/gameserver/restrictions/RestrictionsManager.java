...
public final class RestrictionsManager
{
	...
	/**
	 * This function is created for enable/disable leave group.
	 * 
	 * @param player
	 * @param target
	 */
	public static boolean canLeaveGroup(Player player) {
		for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canLeaveGroup.ordinal()]) {
			if (!restrictions.canLeaveGroup(player)) {
				return false;
			}
		}
		return true;
