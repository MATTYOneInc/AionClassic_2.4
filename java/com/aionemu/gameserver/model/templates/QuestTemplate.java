...
public class QuestTemplate
{
	...
	@XmlElement(name = "thunderer_selectable_reward")
	protected List<QuestItems> thundererSelectableReward;
	...
	public List<QuestItems> getThundererSelectableReward() {
		if (thundererSelectableReward == null) {
			thundererSelectableReward = new ArrayList<QuestItems>();
		}
		return this.thundererSelectableReward;
	}
