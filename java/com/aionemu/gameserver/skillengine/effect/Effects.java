...
public class Effects
{
	@XmlElements({
		...
		@XmlElement(name = "shadowmove", type = ShadowMoveEffect.class),
		@XmlElement(name = "sphealinstant", type = SPHealInstantEffect.class),
		@XmlElement(name = "timefreezing", type = TimeFreezingEffect.class),
