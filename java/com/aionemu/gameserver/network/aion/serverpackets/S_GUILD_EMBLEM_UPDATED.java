 ...
 */
public class S_GUILD_EMBLEM_UPDATED extends AionServerPacket {
	 ...
	 * @param emblemType
	 */
	public S_GUILD_EMBLEM_UPDATED(int legionId, int emblemId, int color_r, int color_g, int color_b,
