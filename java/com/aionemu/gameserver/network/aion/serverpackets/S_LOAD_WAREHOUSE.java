 ...
 * @author kosyachok
 */
public class S_LOAD_WAREHOUSE extends AionServerPacket {
	...
	public S_LOAD_WAREHOUSE(Collection<Item> items, int warehouseType, int expandLvl, boolean firstPacket, Player player) {
