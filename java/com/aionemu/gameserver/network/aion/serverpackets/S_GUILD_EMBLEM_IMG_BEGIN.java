 ...
 */
public class S_GUILD_EMBLEM_IMG_BEGIN extends AionServerPacket {
	 ...
	 */
	public S_GUILD_EMBLEM_IMG_BEGIN(int legionId, int emblemId, int color_r, int color_g, int color_b, String legionName,
