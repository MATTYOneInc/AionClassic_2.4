...
public class S_FUNCTIONAL_PET extends AionServerPacket
{
	...
	public S_FUNCTIONAL_PET(int subType, int actionId, int objectId, int count, Pet pet) {
	...
	public S_FUNCTIONAL_PET(int actionId) {
		this.actionId = actionId;
	}
	
	public S_FUNCTIONAL_PET(int actionId, Pet pet) {
		this(0, actionId, 0, 0, pet);
	}
	
	public S_FUNCTIONAL_PET(boolean isLooting) {
		this.actionId = 13;
		this.isActing = isLooting;
		this.subType = 3;
	}

	public S_FUNCTIONAL_PET(boolean isLooting, int npcId) {
		this(isLooting);
		this.lootNpcId = npcId;
	}
	
	public S_FUNCTIONAL_PET(int dopeAction, boolean isBuffing) {
		this.actionId = 13;
	...
	public S_FUNCTIONAL_PET(int dopeAction, int itemId, int slot) {
		this(dopeAction, true);
		itemObjectId = itemId;
		dopeSlot = slot;
	}
	
	public S_FUNCTIONAL_PET(Pet pet, int subType, int shuggleEmotion) {
		this(0, PetAction.MOOD.getActionId(), 0, 0, pet);
		this.shuggleEmotion = shuggleEmotion;
		this.subType = subType;
	}
	
	public S_FUNCTIONAL_PET(int actionId, PetCommonData commonData) {
		this.actionId = actionId;
		this.commonData = commonData;
	}
	
	public S_FUNCTIONAL_PET(int actionId, Collection<PetCommonData> pets) {
		this.actionId = actionId;
		this.pets = pets;
	}
