 ...
 * @author Simple
 */
public class S_CHANGE_GUILD_MEMBER_INFO extends AionServerPacket {
	...
	public S_CHANGE_GUILD_MEMBER_INFO(Player player, int msgId, String text) {
		this.player = player;
		this.msgId = msgId;
		this.text = text;
	...
	public S_CHANGE_GUILD_MEMBER_INFO(LegionMemberEx LM, int msgId, String text) {
		this.LM = LM;
		this.msgId = msgId;
		this.text = text;
	...
	public S_CHANGE_GUILD_MEMBER_INFO(Player player) {
		this.player = player;
